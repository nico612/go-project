...
import (
	...
	"github.com/nico612/go-project/example/ent/internal/data/ent/predicate"
)
...
func RegisteredAtContains(v string) predicate.Car {
	return predicate.Car(sql.FieldContains(FieldRegisteredAt, v))
}
...
func RegisteredAtHasPrefix(v string) predicate.Car {
	return predicate.Car(sql.FieldHasPrefix(FieldRegisteredAt, v))
}
...
func RegisteredAtHasSuffix(v string) predicate.Car {
	return predicate.Car(sql.FieldHasSuffix(FieldRegisteredAt, v))
}
...
func RegisteredAtEqualFold(v string) predicate.Car {
	return predicate.Car(sql.FieldEqualFold(FieldRegisteredAt, v))
}
...
func RegisteredAtContainsFold(v string) predicate.Car {
	return predicate.Car(sql.FieldContainsFold(FieldRegisteredAt, v))
}
