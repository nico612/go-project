...
import (
	...
	"github.com/nico612/go-project/example/ent/internal/data/ent/car"
...
func (cu *CarUpdate) SetNillableRegisteredAt(s *string) *CarUpdate {
	if s != nil {
		cu.SetRegisteredAt(*s)
	}
	return cu
}
...
func (cu *CarUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.RegisteredAt(); ok {
		_spec.SetField(car.FieldRegisteredAt, field.TypeString, value)
	}
...
// SetNillableRegisteredAt sets the "registered_at" field if the given value is not nil.
func (cuo *CarUpdateOne) SetNillableRegisteredAt(s *string) *CarUpdateOne {
	if s != nil {
		cuo.SetRegisteredAt(*s)
	}
	return cuo
}
